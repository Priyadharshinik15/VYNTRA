    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This road doesn't exist on the map yet.
        </p>
        <Link
          to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TrafficOps AI — Predict • Navigate • Optimize" },
      { name: "description", content: "AI-powered traffic prediction and smart navigation platform for modern cities." },
      { property: "og:title", content: "TrafficOps AI" },
      { property: "og:description", content: "Predict congestion before it happens. Navigate smarter with AI-powered routing." },
